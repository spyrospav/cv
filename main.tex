...
\begin{enumerate}[nosep, label={[\arabic*]}]  
  ...
  \item Haoran Zhang, Konstantinos Kallas,  \authorme, Rajeev Alur, Sebastian Angel, Vincent Liu ``MuCache: A General Framework for Caching in Microservice Graphs''. \emph{Under Submission}.
